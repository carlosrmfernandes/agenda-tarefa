...
import { Plus, Search, Users, Home, X, Calendar, User, FileText } from "lucide-react";
...
const carregarDados = async () => {
  ...
  const filteredTasks = tasks.filter((task) => {
    ...
    const matchesUser = filterUser === "all" || task.id_usuario.toString() === filterUser;
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Gerencie todas as suas atividades</p>
            </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTasks.map((task) => {
              ...
              return (
                <div key={task.id} className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200">
                  <div className="p-6">
                    <div className="mb-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">{task.titulo}</h3>
                      <p className="text-gray-600 text-sm line-clamp-2">{task.descricao}</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>{new Date(task.prazo_final).toLocaleDateString('pt-BR')}</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
